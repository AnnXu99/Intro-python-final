...
data_x = open('C:/Users/bucol/IdeaProjects/Intro-python-final1/dataX2.csv')
data_y = open('C:/Users/bucol/IdeaProjects/Intro-python-final1/dataY2.csv')
